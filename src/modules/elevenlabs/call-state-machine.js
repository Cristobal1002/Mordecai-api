export const CALL_STATES = Object.freeze({
  ...
  CAPTURE_FIRST_PAYMENT_DATE: 'CAPTURE_FIRST_PAYMENT_DATE',
  ...
  POST_DELIVERY_CONFIRM: 'POST_DELIVERY_CONFIRM',
  INTERRUPTION: 'INTERRUPTION',
  DISPUTE_CAPTURE: 'DISPUTE_CAPTURE',
  EXECUTE_DISPUTE: 'EXECUTE_DISPUTE',
  POST_DISPUTE_CONFIRM: 'POST_DISPUTE_CONFIRM',
  CLOSE: 'CLOSE',
});
...
const TRANSITIONS = Object.freeze({
  ...
  [CALL_STATES.CAPTURE_FIRST_PAYMENT_DATE]: new Set([
    CALL_STATES.CAPTURE_FIRST_PAYMENT_DATE,
    CALL_STATES.CONFIRM_AGREEMENT,
    CALL_STATES.CAPTURE_DELIVERY_CHANNEL,
    CALL_STATES.CAPTURE_INSTALLMENTS,
  ...
  [CALL_STATES.POST_DELIVERY_CONFIRM]: new Set([
    CALL_STATES.POST_DELIVERY_CONFIRM,
    CALL_STATES.INTERRUPTION,
    CALL_STATES.CLOSE,
  ]),
  ...
  [CALL_STATES.POST_DISPUTE_CONFIRM]: new Set([
    CALL_STATES.POST_DISPUTE_CONFIRM,
    CALL_STATES.INTERRUPTION,
    CALL_STATES.CLOSE,
  ]),
  [CALL_STATES.INTERRUPTION]: new Set([
    CALL_STATES.INTERRUPTION,
    CALL_STATES.VERIFY_IDENTITY,
    CALL_STATES.DISCLOSE_DEBT,
    CALL_STATES.PLAN_SELECTION,
